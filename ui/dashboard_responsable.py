...
class TableauBordResponsable(QWidget):
    ...
    def _construire_interface(self):
        ...
        role.setStyleSheet("color: gray; font-size: 12px;")
        infos.addWidget(nom)
    ...
    def _rafraichir_stats(self):
        ...
        cartes = QHBoxLayout()
        cartes.addWidget(self._carte_stat("Recettes du jour", f"{ventes_jour['total']:,.0f} F".replace(",", " ")))
        cartes.addWidget(self._carte_stat("Dépenses du jour", f"{depenses_jour['total']:,.0f} F".replace(",", " ")))
