...
def enregistrer_vente(utilisateur, lignes_panier, type_document="ticket"):
    """
    Enregistre une vente complète, dans une seule transaction (tout réussit,
    ou rien n'est écrit — voir Database.transaction) :
    1. Décrémente le stock de façon atomique (protégé contre la vente
    ...
    with Database.transaction() as cur:
        ...
        # même de l'écriture, donc deux ventes simultanées ne peuvent pas
